...
const getInfo = (arr) => {
  ...
  function filterData(arr) {
    ...
    for (let i of Object.keys(arr)) {
      ...
      allStudent.push(arr[i].Students)

    }

    for (let i of Object.keys(allStudent)) {
      for (let index in allStudent[i]) {
        let studentName = allStudent[i];
        studentsName.push(studentName[index]);
      }
    }
    return arr;
  }
...
// The Head manager wants to get more organized info about some students, he wants you to find the students from 
//the courses dataset and return their info following the below structure
//
